...
export const authSlice = createSlice({
	...
	initialState,
	reducers: {
		setRegister: (state, { payload }: PayloadAction<{token: string, qrCode: string}>) => {
		...
		setAuthenticatedUser: (state, { payload }: PayloadAction<{ token: string, user: any; }>) => {
...
export const { setAuthenticated, setIdentityToken, setRegister, setLogin, setAuthenticatedUser, setToken } = authSlice.actions;

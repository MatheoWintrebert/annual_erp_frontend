...
import { fieldCannotBeEmpty, passwordValidationTextMin, passwordValidationTextMax } from '@/constants/messages';
...
export const FieldPassword = ({
	...
	return (
		<FormControl error={!!errors[name]} sx={{ width: '100%' }}>
			{label && (
				<Typography component={'label'} mb={0.5} variant={'body3'} htmlFor={name} sx={{ cursor: 'pointer' }}>
					{label}
				</Typography>
			)}
			<TextField

import { Typography, FormControl, FormHelperText, TextField, useTheme } from '@mui/material';
...
export const FieldEmail = ({
	...
	return (
		<FormControl error={!!errors[name]} sx={sxForm ? sxForm : { width: '100%' }}>
			{label &&
				(labelAccount ? (
					...
					<Typography component={'label'} variant={'body3'} mb={0.5} htmlFor={name} sx={{ cursor: 'pointer' }}>
						{label}
					</Typography>
				))}
			<TextField
